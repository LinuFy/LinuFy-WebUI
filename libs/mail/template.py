...
def mail_with_action(title, message, button_text, button_link):
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                <tr>
                  <td class="content-block powered-by" style="font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; color: #999999; font-size: 12px; text-align: center;" valign="top" align="center">
                    Powered by <a href="https://github.com/LinuFy" style="color: #999999; font-size: 12px; text-align: center; text-decoration: none;">LinuFy</a>.
                  </td>
                </tr>
              </table>
            </div>
...
"""
	return template.replace('[TITLE]', title).replace('[MESSAGE]', message).replace('[BUTTON_LINK]', button_link).replace('[BUTTON_TEXT]', button_text)


def mail_without_action(title, message):
	template = """<!doctype html>
<html>
  <head>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
